...
colnames(tbl) = c("Dictionary Used", "Sentiment Before Deadpool 2 Premier","Sentiment After Deadpool 2 Premier","Difference","Percent Change")
...
kable(tbl) %>% kable_styling(bootstrap_options = c("striped", "hover","responsive", "bordered"), font_size = 20) %>%
  ...
  footnote(general = "Combo dictionary is using a combined and augmented version of Jocker’s (2017) & Rinker’s augmented Hu & Liu (2004) dictionaries")
