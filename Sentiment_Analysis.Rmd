...
As you can see, there are many applications of nlp but our focus today will be mainly to the first two categories, syntax and semantic and I'll be explaining what those are along the way. But first I want to ask you a simple question: what movies do you like to see?
...
Using the syuzhet dictionary, we now get an average sentiment score of about 0.2 which is not that much terribly more than what we got previously. 
...
Having inspected the sentiment prior to Deadpool 2's premier, we would like to do the same analysis as more and more people see and tweet about the movie. 
...
A word of caution is advised with the intrepations of these sentiments because the feelings of fear and disgust are not always pernicious premonitions. Consider how the success of a horror depends on you actually feeling scared which is strictly a negative emotion while it, paradoxically, invokes a positive attitude towards that particular film. Although Deadpool is an overall comical film, it does make you laugh by intertwining gory violence, drug use and sexual references to it's humor.  
